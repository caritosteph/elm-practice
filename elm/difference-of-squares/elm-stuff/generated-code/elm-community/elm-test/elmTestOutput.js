				...
				_0: A2(
					...
					function (_p0) {
						...
						return A2(
							...
							225,
							_exercism$elm$DifferenceOfSquares$squareOfSum(5));
					}),
				_1: {
					ctor: '::',
						...
						A2(
							...
							function (_p2) {
								...
								return A2(
									_elm_community$elm_test$Expect$equal,
									3025,
									_exercism$elm$DifferenceOfSquares$squareOfSum(10));
							})),
					_1: {
						ctor: '::',
						_0: _elm_community$elm_test$Test$skip(
							A2(
								...
								function (_p4) {
									...
									return A2(
										_elm_community$elm_test$Expect$equal,
										25502500,
										_exercism$elm$DifferenceOfSquares$squareOfSum(100));
								})),
						_1: {ctor: '[]'}
					}
				}
						...
						A2(
							...
							function (_p6) {
								...
								return A2(
									_elm_community$elm_test$Expect$equal,
									55,
									_exercism$elm$DifferenceOfSquares$sumOfSquares(5));
							})),
					_1: {
						ctor: '::',
						_0: _elm_community$elm_test$Test$skip(
							A2(
								...
								function (_p8) {
									...
									return A2(
										_elm_community$elm_test$Expect$equal,
										385,
										_exercism$elm$DifferenceOfSquares$sumOfSquares(10));
								})),
						_1: {
							ctor: '::',
							_0: _elm_community$elm_test$Test$skip(
								A2(
									...
									function (_p10) {
										...
										return A2(
											_elm_community$elm_test$Expect$equal,
											338350,
											_exercism$elm$DifferenceOfSquares$sumOfSquares(100));
									})),
							_1: {ctor: '[]'}
						}
					}
							...
							A2(
								...
								function (_p12) {
									...
									return A2(
										_elm_community$elm_test$Expect$equal,
										0,
										_exercism$elm$DifferenceOfSquares$difference(0));
								})),
						_1: {
							ctor: '::',
							_0: _elm_community$elm_test$Test$skip(
								A2(
									...
									function (_p14) {
										...
										return A2(
											_elm_community$elm_test$Expect$equal,
											170,
											_exercism$elm$DifferenceOfSquares$difference(5));
									})),
							_1: {
								ctor: '::',
								_0: _elm_community$elm_test$Test$skip(
									A2(
										...
										function (_p16) {
											...
											return A2(
												_elm_community$elm_test$Expect$equal,
												2640,
												_exercism$elm$DifferenceOfSquares$difference(10));
										})),
								_1: {
									ctor: '::',
									_0: _elm_community$elm_test$Test$skip(
										A2(
											...
											function (_p18) {
												...
												return A2(
													_elm_community$elm_test$Expect$equal,
													25164150,
													_exercism$elm$DifferenceOfSquares$difference(100));
											})),
									_1: {ctor: '[]'}
								}
							}
...
var report = "console";
var pipeFilename = "/tmp/elm_test-5925.sock";
